...
@Component
@Profile("web")
public class WebTestCaseInterruptor implements TestCaseInterruptor {

	@Override
	public void stop(TestCase testCase) {
		testCase.setState(State.FINAL);
		if (testCase.getExecutionMode().equals(ExecutionMode.ASYNCHRONOUS)) {
