...
public class TopConceptshavingBroaderConceptsTest {
	...
	public void testSkosWithSolelyTransitivelyRelatedConcepts() {
		topConceptsHavingBroaderConcepts.reset();
		...
		executionParameters.put(TestParameters.Values.VOCABULARY, "q17_invalid");
		topConceptsHavingBroaderConcepts.setExecutionParameters(executionParameters);
		topConceptsHavingBroaderConcepts.run();
		Result result = topConceptsHavingBroaderConcepts.getResult();

		Assert.assertEquals("There should be exactly 4 errors.", 4, result.getErrorCount());
		String uri = "file:/tmp/resourceE";
