...
public class InconsistentPrefLabelsTest {
	...
	public void testSkosWithRelationClashes() {
		...
		executionParameters.put(TestParameters.Values.VOCABULARY, "q27_invalid");
		inconsistentPrefLabels.setExecutionParameters(executionParameters);
		inconsistentPrefLabels.run();
		Result result = inconsistentPrefLabels.getResult();

		Assert.assertEquals("There should be exactly 4 errors.", 4, result.getErrorCount());
		String uri = "file:/tmp/conceptA2";
		String concept = "Concept A2";
		String ambiguous1 = "Concept A2, ambiguous";
		String ambiguous2 = "Concept A2, one more ambiguous";
		assertContainsMessage(result, Message.Type.ERROR, new String[] {},
				new String[] { uri, concept, ambiguous1, ambiguous2 });
