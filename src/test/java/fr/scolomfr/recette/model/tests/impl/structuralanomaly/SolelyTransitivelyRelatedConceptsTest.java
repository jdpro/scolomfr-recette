...
public class SolelyTransitivelyRelatedConceptsTest {
	...
	public void testSkosWithSolelyTransitivelyRelatedConcepts() {
		solelyTransitivelyRelatedConcepts.reset();
		...
		executionParameters.put(TestParameters.Values.VOCABULARY, "q14_invalid");
		solelyTransitivelyRelatedConcepts.setExecutionParameters(executionParameters);
		solelyTransitivelyRelatedConcepts.run();
		Result result = solelyTransitivelyRelatedConcepts.getResult();

		Assert.assertEquals("There should be exactly 4 errors.", 4, result.getErrorCount());
		String uri1 = "file:/tmp/conceptJ";
		String uri2 = "file:/tmp/conceptK";
